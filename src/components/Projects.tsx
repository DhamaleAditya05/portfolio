...
const projects = [
  {
    ...
    icon: "🔐",
    impact: "15-20% helpdesk ticket reduction",
    duration: "3 months",
    description:
    ...
    details: [
      ...
      "Reduced helpdesk ticket volume by 15-20% through intelligent automation.",
    ...
    highlights: [
      { label: "VMs Secured", value: "2000+" },
      { label: "Ticket Reduction", value: "20%" },
      { label: "Automation Scripts", value: "15+" },
    ],
  },
  {
    title: "Automated Virtual Desktop Change Tracking System",
    subtitle: "Disaster Recovery & Configuration Management",
    tags: ["PowerShell", "Task Scheduler", "Hyper-V", "Veeam"],
    ...
    highlights: [
      ...
      { label: "Daily Snapshots", value: "Automatic" },
